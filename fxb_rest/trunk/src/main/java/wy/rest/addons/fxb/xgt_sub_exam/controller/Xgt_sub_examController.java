...
public class Xgt_sub_examController extends BaseController {
    ...
    @ResponseBody
    public Object examlist(@RequestParam Integer sub_exam_id){
        List<Map<String, Object>>examList = this.xgt_sub_examDao.examList(sub_exam_id);
        return examList;
    }
    ...
    @ResponseBody
    public String findName(@RequestParam Integer sub_exam_id){
        String name = this.xgt_sub_examDao.findName(sub_exam_id);
        return name;
    }
}
