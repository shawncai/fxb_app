...
public class Xgt_sub_task_dtlController extends BaseController {
    ...
    //历史作业单选题完成情况
    @RequestMapping(value = "/historyDanxuan")
    @ResponseBody
    public Object XuanZelist(@RequestParam Integer Id,@RequestParam Integer task_id){
        List<Map<String, Object>> historyDanxuan = this.xgt_sub_task_dtlDao.historyDanxuan(Id,task_id);
        System.err.println(historyDanxuan);
        return historyDanxuan;
    }
}
