...
public interface Xgt_sub_qpDao {
    ...
    List<Map<String, Object>> getWanxing(@Param("subexamId") Integer subexamId);

    List<Map<String, Object>> getYuedu(@Param("subexamId") Integer subexamId);

    List<Map<String, Object>> getRenwu(@Param("subexamId") Integer subexamId);
